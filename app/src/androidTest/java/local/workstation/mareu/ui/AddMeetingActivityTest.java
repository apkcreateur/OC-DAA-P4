...
import static local.workstation.mareu.utils.dummies.DummyCalendarGenerator.TODAY_INVALID_START_TIME;
import static local.workstation.mareu.utils.dummies.DummyCalendarGenerator.TOMORROW_INVALID_END_TIME;
import static local.workstation.mareu.utils.dummies.DummyCalendarGenerator.TOMORROW_VALID_END_TIME;
import static local.workstation.mareu.utils.dummies.DummyCalendarGenerator.TOMORROW_VALID_START_TIME;
import static local.workstation.mareu.utils.dummies.DummyCalendarGenerator.YESTERDAY;
import static local.workstation.mareu.utils.dummies.DummyEmailGenerator.INVALID_EMAIL;
import static local.workstation.mareu.utils.dummies.DummyEmailGenerator.VALID_EMAIL_1;
import static local.workstation.mareu.utils.dummies.DummyEmailGenerator.VALID_EMAIL_2;
